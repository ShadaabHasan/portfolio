                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <nav className="flex flex-col space-y-2">
                                <a className="text-sm text-foreground/60 hover:text-foreground" href="/about/">About</a>
                                <a className="text-sm text-foreground/60 hover:text-foreground" href="/projects/">Projects</a>
