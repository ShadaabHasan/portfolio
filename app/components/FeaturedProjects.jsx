    ...
    <>
      <section className="">
                    <div className="container mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 p-5">
                                ...
                                <div className="bg-card rounded-lg shadow-lg overflow-hidden h-full flex flex-col">
                                    ...
                                    <div className="p-6 space-y-4">
                                        <div>
                                            ...
                                            {/* <div className="inline-block rounded-full bg-primary/10 px-2 py-1 text-xs text-primary mb-2">Featured Project</div> */}
                                            <p className="text-muted-foreground">A computer vision project focused on early detection of skin cancer by analyzing digital images of skin lesions. The process involves image acquisition, preprocessing for quality enhancement, feature extraction capturing color, texture, and shape characteristics, and classification using machine learning or deep learning algorithm like CNNs. The model is trained on labeled datasets, validated, and tested for accuracy and generalization.</p>
                                        </div>
                                        <div className="flex flex-wrap gap-2">
